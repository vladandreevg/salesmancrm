		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
					...
					+	'				</a>'
					+	'			</div>'
					+	'			<div id="ptTimeSelectUserTime" style="float: left;" class="red">'
					...
					+	'					<div class="ptTimeSelectLeftPane" style="width: 60%; text-align: center; float: left;" class="">Часы</div>'
					+	'					<div class="ptTimeSelectRightPane" style="width: 40%; text-align: center; float: left;">Минуты</div>'
					+	'				</div>'
					+	'				<div>'
...
jQuery.ptTimeSelect.setTime2 = function() {
	var tSel = jQuery('#ptTimeSelectUserSelHr').text()
				+ ":"
				+ jQuery('#ptTimeSelectUserSelMin').text()
				//+ " "
