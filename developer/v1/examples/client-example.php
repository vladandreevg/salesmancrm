...
$baseurl = "https://demo.isaler.ru/developer/v1/client";//Адрес расположения CRM

$params['login'] = "zaharbor@isaler.ru";//существующий пользователь в системе
$params['apikey'] = 'eY8VqURqbsHLtB4SOmXDjdkoz2pL5k';//'aMgiCQyj8bCToNc47BZZYrRICoWSIl'; //получаем в Панели управления CRM
...
//$params['clid'] = '1526'; //указываем id записи
//$params['uid'] = '1001'; //указываем uid записи
...
$params['user'] = '';
$params['title'] = 'Пробный клиент API plus 8';
...
$params['recv']['castUrName'] = 'ООО "Пробный клиент API plus 8"';
...
$params['recv']['castOkpo'] = '01234567890';
$params['recv']['castOgrn'] = '1145958040260';
$params['recv']['castDirName'] = 'Косых Виталия Владимировича';
$params['recv']['castDirSignature'] = 'Косых В.В.';
...
$params['recv']['castUrAddr'] = 'г. Пермь, ул. Пушкина 66';
*/
