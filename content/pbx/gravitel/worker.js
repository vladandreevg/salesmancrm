...
function getLastCalls(){
	...
	var url = '/content/pbx/gravitel/peers.php?action=lastcolls';
	var sms = '';
...
function synchist(){
	...
	var url = '/content/pbx/gravitel/cdr.php';
	$.post(url);
...
function inpeers(){
	...
	if(isWork !== 'yes' || adelta > atime){
		...
		$.getJSON('/content/pbx/gravitel/peers.php?action=getIncoming', function(data){
