...
function getLastCalls(){
	...
	var url = '/content/pbx/onlinepbx/peers.php?action=lastcolls';
	var sms = '';
...
function synchist(){
	...
	var url = '/content/pbx/onlinepbx/cdr.php';
	$.post(url);
...
function inpeers(){
	...
	var isWork = localStorage.getItem("onlinepbxWork");
	var oldtime = parseInt(localStorage.getItem("onlinepbxWorkTime"));
	...
	if(isWork !== 'yes' || adelta > atime){
		...
		localStorage.setItem("onlinepbxWork", 'yes');
		localStorage.setItem("onlinepbxWorkTime", Date.now());

		$.getJSON('/content/pbx/onlinepbx/peers.php?action=getIncoming', function(data){
			...
			.done( function(){
				...
				localStorage.setItem("onlinepbxWork", '');
