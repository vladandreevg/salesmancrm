				...
				if (count($soc) > 0 && $person['social'] != "") {
					...
					<div class="flex-container p10">
						...
						<div class="flex-string wp75">
							<?php
							if ($soc[0] != '') {
								print '<DIV class="tcn"><a href="http://'.str_replace("http://", "", $soc[0]).'" target="_blank" title="'.$soc[0].'"><b>Блог</b>&nbsp;<i class="icon-globe broun"></i></a></DIV>&nbsp;';
							}
							if ($soc[1] != '') {
								print '<DIV class="tcn"><a href="http://'.str_replace("http://", "", $soc[1]).'" target="_blank" title="'.$soc[1].'"><b>Сайт</b>&nbsp;<i class="icon-globe broun"></i></a></DIV>&nbsp;';
							}
							if ($soc[2] != '') {
								print '<DIV class="tcn"><a href="http://twitter.com/#!/'.str_replace("http://twitter.com/#!/", "", $soc[2]).'" target="_blank" title="'.$soc[2].'"><b>Twitter</b>&nbsp;<i class="icon-twitter blue"></i></a></DIV>&nbsp;';
							}
							if ($soc[3] != '') {
								print '<DIV class="tcn"><b>ICQ '.$soc[3].'</b>&nbsp;<i class="icon-cog-1 green"></i></DIV>&nbsp;';
							}
							if ($soc[4] != '') {
								print '<DIV class="tcn"><a href="skype:'.$soc[4].'" target="_blank" title="Позвонить: '.$soc[4].'">&nbsp;<i class="icon-skype green"></i>&nbsp;<b>'.$soc[4].'</b></a> или <a href="skype:'.$soc[4].'?chat" title="Начать чат: '.$soc[4].'">&nbsp;<i class="icon-skype green"></i>&nbsp;<b>'.$soc[4].'</b></a></DIV>&nbsp;';
							}
							if ($soc[5] != '') {
								print '<DIV class="tcn"><a href="http://'.str_replace("http://", "", $soc[5]).'" target="_blank" title="'.$soc[6].'"><b>Google+</b>&nbsp;<i class="icon-gplus-squared red"></i></a></DIV>&nbsp;';
							}
							if ($soc[6] != '') {
								print '<DIV class="tcn"><a href="http://'.str_replace("http://", "", $soc[6]).'" target="_blank" title="'.$soc[6].'"><b>Facebook</b>&nbsp;<i class="icon-facebook-squared blue"></i></a></DIV>&nbsp;';
							}
							if ($soc[7] != '') {
								print '<DIV class="tcn"><a href="http://'.str_replace("http://", "", $soc[7]).'" target="_blank" title="'.$soc[6].'"><b>VKontakte</b>&nbsp;<i class="icon-vkontakte blue"></i></a></DIV>&nbsp;';
							}
							?>
						</div>
