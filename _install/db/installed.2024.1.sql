...
CREATE TABLE `app_complect_cat` (
    ...
    `title` VARCHAR(200) NULL  DEFAULT  NULL COMMENT 'название контрольной точки',
    `corder` INT NULL  COMMENT 'порядок вывода',
    `dstep` INT NULL  COMMENT 'привязка к этапу сделки _dogcategory.idcategory',
...
INSERT INTO `app_field` VALUES ('15','client','input1','доп.поле',NULL,NULL,'14','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('16','client','input2','доп.поле',NULL,NULL,'20','no','--Обычное--','до 3х,св.3 до 10,св.10 до 50,св.50','1');#%%
INSERT INTO `app_field` VALUES ('17','client','input3','доп.поле',NULL,NULL,'15','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('1','client','title','Название','required','yes','1','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('2','client','iduser','Ответственный','required','yes','3','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('3','client','idcategory','Категория','','','5','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('4','client','head_clid','Головн. орг-ия','','','2','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('5','client','pid','Осн. контакт','','','9','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('6','client','address','Адрес','','yes','8','yes','adres','','1');#%%
INSERT INTO `app_field` VALUES ('7','client','phone','Телефон','','yes','4','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('8','client','fax','Факс','','yes','10','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('9','client','site_url','Сайт',NULL,'yes','7','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('10','client','mail_url','Почта',NULL,'yes','6','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('11','client','territory','Территория','','','13','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('12','client','des','Описание',NULL,'','18','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('13','client','scheme','Принятие решений','','','17','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('14','client','tip_cmr','Тип отношений','','','11','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('25','person','clid','Клиент','','yes','5','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('26','person','ptitle','Должность','required','yes','2','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('27','person','person','Ф.И.О.','required','yes','1','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('28','person','tel','Тел.','','yes','6','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('29','person','fax','Факс',NULL,'yes','8','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('30','person','mob','Моб.','','yes','9','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('31','person','mail','Почта','','yes','11','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('32','person','rol','Роль','','','3','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('33','person','social','Прочее',NULL,'','14','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('34','person','iduser','Куратор','required','yes','4','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('35','person','loyalty','Лояльность','','','12','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('36','person','input1','Дата рождения','','','13','no','datum','','1');#%%
INSERT INTO `app_field` VALUES ('37','person','input2','доп.поле',NULL,NULL,'15','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('38','person','input3','доп.поле',NULL,NULL,'16','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('39','person','input4','доп.поле',NULL,NULL,'17','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('40','person','input5','доп.поле',NULL,NULL,'18','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('41','person','input6','доп.поле',NULL,NULL,'19','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('42','person','input7','Добавочный',NULL,'yes','7','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('43','person','input8','доп.поле','','','20','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('44','person','input9','доп.поле','','','21','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('18','client','input4','доп.поле',NULL,NULL,'16','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('19','client','input5','доп.поле',NULL,NULL,'21','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('20','client','input6','доп.поле',NULL,NULL,'22','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('21','client','input7','доп.поле',NULL,NULL,'23','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('22','client','input8','доп.поле',NULL,NULL,'25','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('23','client','input9','доп.поле',NULL,NULL,'24','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('24','client','input10','доп.поле',NULL,NULL,'26','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('45','client','recv','Реквизиты','','yes','19','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('46','client','clientpath','Источник клиента','','','12','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('47','person','clientpath','Канал привлечения','','','10','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('48','dogovor','zayavka','Номер заявки','','','1','no','','','1');#%%
INSERT INTO `app_field` VALUES ('49','dogovor','ztitle','Основание','','','1','no','','','1');#%%
INSERT INTO `app_field` VALUES ('50','dogovor','mcid','Компания','required','yes','2','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('51','dogovor','iduser','Куратор','required','yes','3','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('52','dogovor','datum_plan','Дата план.','required','yes','4','yes','datum','','1');#%%
INSERT INTO `app_field` VALUES ('53','dogovor','period','Период действия',NULL,'','5','no','','','1');#%%
INSERT INTO `app_field` VALUES ('54','dogovor','idcategory','Этап','','yes','6','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('55','dogovor','dog_num','Договор','','yes','7','no','','','1');#%%
INSERT INTO `app_field` VALUES ('56','dogovor','tip','Тип сделки','required','yes','8','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('57','dogovor','direction','Направление','required','yes','9','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('58','dogovor','adres','Адрес','','','10','no','','','1');#%%
INSERT INTO `app_field` VALUES ('59','dogovor','money','Деньги',NULL,'yes','11','yes','','','1');#%%
INSERT INTO `app_field` VALUES ('60','dogovor','content','Описание','','','12','no','','','1');#%%
INSERT INTO `app_field` VALUES ('61','dogovor','pid_list','Персоны','','yes','13','no','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('62','dogovor','payer','Плательщик','','yes','14','yes','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('64','dogovor','kol','Сумма план.','','yes',NULL,'yes','','','1');#%%
INSERT INTO `app_field` VALUES ('65','dogovor','kol_fact','Сумма факт.','','yes',NULL,'yes','','','1');#%%
INSERT INTO `app_field` VALUES ('66','dogovor','marg','Прибыль','','yes',NULL,'yes','','','1');#%%
INSERT INTO `app_field` VALUES ('67','dogovor','oborot','Сумма','','yes',NULL,'yes','','','1');#%%
INSERT INTO `app_field` VALUES ('68','price','price_in','Закуп','required','yes',NULL,'','','','1');#%%
INSERT INTO `app_field` VALUES ('69','price','price_1','Розница','required','yes',NULL,'','','35','1');#%%
INSERT INTO `app_field` VALUES ('70','price','price_2','Уровень 1','','yes',NULL,'','','25','1');#%%
INSERT INTO `app_field` VALUES ('71','price','price_3','Уровень 2','required','yes',NULL,'','','20','1');#%%
INSERT INTO `app_field` VALUES ('72','price','price_4','Уровень 3','','',NULL,'','','15','1');#%%
INSERT INTO `app_field` VALUES ('73','price','price_5','Уровень 4','','',NULL,'','','10','1');#%%
INSERT INTO `app_field` VALUES ('880','dogovor','input1','доп.поле',NULL,NULL,'19','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('881','dogovor','input2','доп.поле',NULL,NULL,'20','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('882','dogovor','input3','доп.поле',NULL,NULL,'21','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('883','dogovor','input4','доп.поле',NULL,NULL,'22','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('884','dogovor','input5','доп.поле',NULL,NULL,'23','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('885','dogovor','input6','доп.поле',NULL,NULL,'24','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('970','dogovor','input7','доп.поле',NULL,NULL,'25','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('971','dogovor','input8','доп.поле',NULL,NULL,'26','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('972','dogovor','input9','доп.поле',NULL,NULL,'27','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('973','dogovor','input10','доп.поле',NULL,NULL,'28','','--Обычное--','','1');#%%
INSERT INTO `app_field` VALUES ('1064','person','input10','доп.поле','','','22','no','','','1');#%%
...
CREATE TABLE `app_file_cat` (
    ...
    `title` VARCHAR(250) NULL  DEFAULT  NULL COMMENT 'название категории',
...
INSERT INTO `app_logs` VALUES ('1','2024-02-05 06:05:08','Авторизация','1','Пользователь авторизовался в системе','1');#%%
INSERT INTO `app_logs` VALUES ('2','2024-02-05 06:05:10','Начало дня','1','Первый запуск за день','1');#%%
INSERT INTO `app_logs` VALUES ('3','2024-02-05 06:05:51','Администрирование','1','Пользователь вошел в панель администратора','1');#%%
...
CREATE TABLE `app_price_cat` (
    `idcategory` INT NOT NULL auto_increment,
    `sub` INT NULL  DEFAULT '0' COMMENT 'Головная категория - _price_cat.idcategory',
...
INSERT INTO `app_user` VALUES ('1','admin','8005bc21aec908edf78f89920fa0438ff52b4bb41f13f0aad327311a1e6ea321efe9e27fd3c1bedde9e1b310764f7ac5f6545f8932f0ba13acbcfbc35934b116d842d68938d07f5c955426ae9e615cffc787551fad','s2ys05sxx4XUPrkQRL949dQuaNNFsQ8H5esA4sAdmlpVDpmLrgQ1eULD5QRu','Administrator','Руководитель организации','Руководитель','0','0',NULL,'admin',NULL,'0','0',NULL,NULL,NULL,NULL,NULL,'on','on','on','on','on','on','0','on;on;on;on;on;on;on;on;on;on;on;on','d1;d2;d5;d7;d4;d6;d3;d8;d9;d10;d11;d12','yes','on','on;on;on;on;on;on;on;on;on;on;on;on;on;on;on;on;on;on;on','yes','on','0',NULL,NULL,'on;off;off;on;off;on;on;on;on;on;on;on;off;off;off;off;off;off',NULL,'xx4XUPrkQRL949dQuaNNFJ8YrnovIGSs',NULL,'{\\\"vigets\\\":{\\\"parameters\\\":\\\"on\\\",\\\"voronka\\\":\\\"on\\\",\\\"analitic\\\":\\\"on\\\",\\\"dogs_renew\\\":\\\"on\\\",\\\"credit\\\":\\\"on\\\",\\\"stat\\\":\\\"on\\\"},\\\"taskAlarm\\\":null,\\\"userTheme\\\":\\\"\\\",\\\"userThemeRound\\\":null,\\\"startTab\\\":\\\"vigets\\\",\\\"menuClient\\\":\\\"my\\\",\\\"menuPerson\\\":\\\"my\\\",\\\"menuDeal\\\":\\\"my\\\",\\\"notify\\\":[\\\"client.add\\\",\\\"client.edit\\\",\\\"client.userchange\\\",\\\"client.delete\\\",\\\"client.double\\\",\\\"person.send\\\",\\\"deal.add\\\",\\\"deal.edit\\\",\\\"deal.userchange\\\",\\\"deal.step\\\",\\\"deal.close\\\",\\\"invoice.doit\\\",\\\"lead.add\\\",\\\"lead.setuser\\\",\\\"lead.do\\\",\\\"comment.new\\\",\\\"comment.close\\\",\\\"task.add\\\",\\\"task.edit\\\",\\\"task.doit\\\",\\\"self\\\"],\\\"filterAllBy\\\":null,\\\"subscribs\\\":null}',NULL,'1');#%%
...
INSERT INTO `app_ver` VALUES ('1','2024.1','2024-02-05 12:04:10');#%%
...
CREATE TABLE `app_ymail_messages` (
    ...
    `state` VARCHAR(50) NULL  DEFAULT  NULL COMMENT 'deleted - удаленные, read - прочитанные, unread - не прочинанны',
