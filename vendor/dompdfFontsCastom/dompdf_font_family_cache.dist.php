...
return array(
    ...
    'pt sans' => 
		array(
			'normal' => $distFontDir . 'PTSans',
			'bold' => $distFontDir . 'PTSans-Bold',
			'italic' => $distFontDir . 'PTSans-Italic',
		),
    'arial narrow' => 
		array(
			'normal' => $distFontDir . 'ArialNarrow',
			'bold' => $distFontDir . 'ArialNarrow-Bold',
			'italic' => $distFontDir . 'ArialNarrow-Italic',
		),
    'arial' => 
		array(
			'normal' => $distFontDir . 'Arial',
			'bold' => $distFontDir . 'Arial-Bold',
			'italic' => $distFontDir . 'Arial-Italic',
		)
);