...
<div style="margin:0 auto;" class="w176">
	...
	<table border="0" cellspacing="0" cellpadding="3" width="100%">
		...
		<tr>
			<td colspan="4" class="br bl">{{compUrName}}</td>
			<td class="br"></td>
			<td class="br"></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellpadding="4" cellspacing="0">
		<tr>
			...
			{{/nalogTitle}}
			<td width="80" align="center" valign="middle" bgcolor="#E9E9E9" class="bt bb br w80">Сумма</td>
		</tr>
		{{#speka}}
		<tr class="small">
			...
			{{/nalogTitle}}
			<td width="80" align="right" valign="middle" class="bb br w80">{{Summa}}</td>
		</tr>
		{{/speka}}
	</table>
	...
	<table width="100%" border="0" cellpadding="4" cellspacing="0">
		<tr>
			...
			<td width="80" align="right" class="bb br" style="height:14px">{{InvoiceSumma}}</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="80" align="right" class="bb br"><b>{{InvoiceSumma}}</b></td>
		</tr>
	</table>
